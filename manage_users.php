...
if (isset($_GET['delete'])) {
    ...
    // 1. Delete appointments where the user is either a patient or doctor
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .actions a.edit:hover { text-decoration: underline; }
        .actions a.delete { color: red; }
        .actions a.delete:hover { text-decoration: underline; }
    </style>
</head>
<body>
            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="?delete=<?= $user['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this user? All related appointments will also be deleted.');">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
